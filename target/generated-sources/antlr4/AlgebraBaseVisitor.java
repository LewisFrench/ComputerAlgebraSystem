...
public class AlgebraBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements AlgebraVisitor<T> {
	 ...
	 */
	@Override public T visitTerm(AlgebraParser.TermContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitInteger(AlgebraParser.IntegerContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
