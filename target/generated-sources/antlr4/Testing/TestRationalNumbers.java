...
public class TestRationalNumbers {
	...
	@Test
	public void testRationalNumbers_Constructor_Numerator_Denominator() {
	...
	@Test
	public void testRationalNumbers_Constructor_Numerator_Denominator_Simplifies() {
	...
	@Test
	public void testRationalNumbers_Constructor_Numerator_Denominator_Normalises() {
		NumberNode n = new NumberNode(BigInteger.valueOf(-3), BigInteger.valueOf(6));
		assertEquals(BigInteger.valueOf(-1), n.getNumerator());
		assertEquals(BigInteger.valueOf(2), n.getDenominator());
	...
	@Test
	public void testRationalNumbers_Constructor_Numerator() {
	...
	@Test
	public void testRationalNumbers_Constructor_Numerator_DenominatorZero() {
	...
	@Test
	public void testRationalNumbers__getReciprocal() {
	...
	@Test
	public void testRationalNumbers__getReciprocal_Normalises() {
		NumberNode n = new NumberNode(BigInteger.valueOf(-6),BigInteger.valueOf(11)).getReciprocal();
		assertEquals(BigInteger.valueOf(-11), n.getNumerator());
		assertEquals(BigInteger.valueOf(6), n.getDenominator());
	}	
	...
	@Test
	public void testRationalNumbers__compareTo_GT() {
	...
	@Test
	public void testRationalNumbers__compareTo_EQ() {
	...
	@Test
	public void testRationalNumbers__compareTo_LT() {
		NumberNode n = new NumberNode(BigInteger.valueOf(5),BigInteger.valueOf(3333));
